...
def months_worked_calculator(star_year, star_month, end_year, end_month):
    ...
    months_worked = (month_of_dismissal.year - month_of_hiring.year) * 12 + (month_of_dismissal.month - month_of_hiring.month)
    return months_worked + 1


def date_string_converter(date_string_month_of_hiring,date_string_month_of_dismissal):
    """
